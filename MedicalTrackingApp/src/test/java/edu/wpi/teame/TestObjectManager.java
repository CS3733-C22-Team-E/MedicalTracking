...
public class TestObjectManager {
    ...
    public void testInsert() throws SQLException {
        ...
        locationManager.insert(loc2);
        locationManager.insert(loc3);
        ...
        patientManager.insert(patient2);
        patientManager.insert(patient3);
        ...
        medicalEquipmentSRManager.insert(sr2);
        medicalEquipmentSRManager.insert(sr3);

        foodDeliverySRManager.insert(food1);
        foodDeliverySRManager.insert(food2);
        foodDeliverySRManager.insert(food3);

        giftAndFloralSRManager.insert(gift1);
        giftAndFloralSRManager.insert(gift2);
        giftAndFloralSRManager.insert(gift3);

        languageInterpreterSRManager.insert(language1);
        languageInterpreterSRManager.insert(language2);
        languageInterpreterSRManager.insert(language3);
        ...
        transportationSRManager.insert(transport2);
        transportationSRManager.insert(transport3);

        religiousSRManager.insert(reg1);
        religiousSRManager.insert(reg2);
        religiousSRManager.insert(reg3);
