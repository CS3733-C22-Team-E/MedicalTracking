...
public class FoodDeliveryServiceRequestPageServiceRequestController
  ...
  void sendToDB() throws SQLException {
    ...
    if (DBManager.getInstance().getCurrentType() == DBType.MongoDB) {
      FoodDeliveryServiceRequest serviceRequest1 =
          DBManager.getInstance()
              .getMongoDatabase()
              .withCodecRegistry(DBManager.getInstance().getObjectCodecs())
              .getCollection("FoodDeliverySR", FoodDeliveryServiceRequest.class)
              .find()
              .sort(descending("_id"))
              .first();
  ...
  public void updateStyle() {
    ...
    StyleManager.getInstance().getCurrentStyle().setLabelStyle(foodT);
    ...
    StyleManager.getInstance().getCurrentStyle().setTextFieldStyle(food);
