...
public class ReligiousServiceRequestPageServiceRequestController extends ServiceRequestController {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    mainAnchorPane.setEffect(new DropShadow(20, DataBaseObjectType.ReligiousSR.getColor()));
  ...
  void sendToDB() throws SQLException {
    ...
    if (DBManager.getInstance().getCurrentType() == DBType.MongoDB) {
      ReligiousServiceRequest serviceRequest1 =
  ...
  public void updateStyle() {
    ...
    StyleManager.getInstance().getCurrentStyle().setLabelStyle(religionT);
    ...
    StyleManager.getInstance().getCurrentStyle().setTextFieldStyle(religion);
