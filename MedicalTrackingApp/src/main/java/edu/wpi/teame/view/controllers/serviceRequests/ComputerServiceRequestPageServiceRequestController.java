...
public class ComputerServiceRequestPageServiceRequestController extends ServiceRequestController {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    mainAnchorPane.setEffect(new DropShadow(20, DataBaseObjectType.ComputerSR.getColor()));
  ...
  void sendToDB() throws SQLException {
    ...
    ServiceRequest serviceRequest =
        new ServiceRequest(
            ...
            "",
            0);
    DBManager.getInstance().getManager(DataBaseObjectType.ComputerSR).insert(serviceRequest);
