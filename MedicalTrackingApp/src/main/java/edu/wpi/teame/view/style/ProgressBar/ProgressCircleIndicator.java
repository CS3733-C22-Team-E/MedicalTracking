 ...
 */
package edu.wpi.teame.view.style.ProgressBar;
...
abstract class ProgressCircleIndicator extends Control {
  ...
  public ProgressCircleIndicator() {
    this.getStylesheets().add(App.class.getResource("css/circleprogress.css").toString());
  }
  ...
  private DoubleProperty innerCircleRadius =
      new StyleableDoubleProperty(20) {
        @Override
