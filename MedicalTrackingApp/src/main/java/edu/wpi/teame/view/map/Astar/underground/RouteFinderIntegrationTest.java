...
public class RouteFinderIntegrationTest {
  ...
  private Graph<Location> underground;
...
//    connections.put(
//        "13", Stream.of("156", "249", "224", "157", "167", "278").collect(Collectors.toSet()));
//    connections.put(
...
//    connections.put(
//        "74", Stream.of("99", "122", "138", "286", "292", "17", "99").collect(Collectors.toSet()));
...
//    connections.put(
//        "90", Stream.of("104", "145", "104", "145", "104", "145").collect(Collectors.toSet()));
...
//    connections.put(
//        "107", Stream.of("28", "284", "133", "196", "191", "272").collect(Collectors.toSet()));
...
//    connections.put(
//        "156",
//        Stream.of("13", "24", "2", "167", "3", "167", "2", "167").collect(Collectors.toSet()));
...
//    connections.put(
//        "167",
//        Stream.of("14", "156", "14", "156", "14", "156", "13", "188").collect(Collectors.toSet()));
...
//    connections.put(
//        "191", Stream.of("196", "211", "28", "258", "107", "276").collect(Collectors.toSet()));
//    connections.put(
//        "192",
//        Stream.of("82", "277", "18", "83", "18", "83", "83", "217").collect(Collectors.toSet()));
...
//    connections.put(
//        "272", Stream.of("228", "247", "228", "247", "107", "197").collect(Collectors.toSet()));
...
//    connections.put(
//        "278", Stream.of("87", "148", "232", "284", "87", "136", "13").collect(Collectors.toSet()));
...
//
//    underground = new Graph<>(locations, connections);
//    routeFinder =
//        new RouteFinder<>(
//            underground, new EuclideanDistanceScorer(), new EuclideanDistanceScorer());
  }
