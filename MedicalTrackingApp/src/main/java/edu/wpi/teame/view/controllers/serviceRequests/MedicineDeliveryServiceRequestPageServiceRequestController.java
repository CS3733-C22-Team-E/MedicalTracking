...
public class MedicineDeliveryServiceRequestPageServiceRequestController
  ...
  public void updateStyle() {
    ...
    StyleManager.getInstance().getCurrentStyle().setLabelStyle(medicineQuantityT);
    StyleManager.getInstance().getCurrentStyle().setLabelStyle(additionalInfoT);
    StyleManager.getInstance().getCurrentStyle().setLabelStyle(medicineNameT);
    ...
    StyleManager.getInstance().getCurrentStyle().setTextFieldStyle(medicineQuantity);
    StyleManager.getInstance().getCurrentStyle().setDatePickerStyle(requestDate);
    StyleManager.getInstance().getCurrentStyle().setTextFieldStyle(medicineName);
