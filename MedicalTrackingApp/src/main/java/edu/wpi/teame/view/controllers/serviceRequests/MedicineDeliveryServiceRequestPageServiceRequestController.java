...
public class MedicineDeliveryServiceRequestPageServiceRequestController
  ...
  @FXML private Label medicineNameT;
  @FXML private Label medicineQuantityT;
  ...
  public void updateStyle() {
    ...
    medicineNameT.setTextFill(StyleManager.getInstance().getCurrentStyle().getTextColor());
    medicineQuantityT.setTextFill(StyleManager.getInstance().getCurrentStyle().getTextColor());
    ...
    medicineNameT.setBackground(StyleManager.getInstance().getCurrentStyle().getForegroundAsBackground());
    medicineQuantityT.setBackground(StyleManager.getInstance().getCurrentStyle().getForegroundAsBackground());
