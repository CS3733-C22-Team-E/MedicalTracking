...
public class ExternalPatientTransportationServiceRequestPageServiceRequestController
  ...
  void sendToDB() throws SQLException {
    ...
    PatientTransportationServiceRequest serviceRequest =
        new PatientTransportationServiceRequest(
            ...
            equipBring,
            patient);
    DBManager.getInstance().getManager(DataBaseObjectType.ExternalPatientSR).insert(serviceRequest);
  ...
  public void updateStyle() {
    ...
    destinationLocationT.setTextFill(StyleManager.getInstance().getCurrentStyle().getTextColor());
    equipmentT.setTextFill(StyleManager.getInstance().getCurrentStyle().getTextColor());
    ...
    assignee.setBackground(
        StyleManager.getInstance().getCurrentStyle().getForegroundAsBackground());
    destinationLocation.setBackground(
        StyleManager.getInstance().getCurrentStyle().getForegroundAsBackground());
