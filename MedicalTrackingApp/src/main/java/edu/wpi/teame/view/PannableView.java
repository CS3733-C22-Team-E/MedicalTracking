...
//  private HashMap<EquipmentType, ImageView> TypeGraphics = new HashMap<EquipmentType,
// ImageView>();
...
//                      "");
//              insertLocation =
// DBManager.getInstance().getLocationManager().insert(insertLocation);
//
...
//          -30 * currEquipment.ordinal() - Screen.getPrimary().getVisualBounds().getHeight() /
// 2.8);
