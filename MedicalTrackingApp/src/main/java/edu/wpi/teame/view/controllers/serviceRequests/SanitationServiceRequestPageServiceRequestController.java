...
public class SanitationServiceRequestPageServiceRequestController extends ServiceRequestController {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    mainAnchorPane.setEffect(new DropShadow(20, DataBaseObjectType.SanitationSR.getColor()));
  ...
  void sendToDB() throws SQLException {
    ...
    ServiceRequest serviceRequest =
        new ServiceRequest(
            ...
            "",
            0);
    DBManager.getManager(DataBaseObjectType.SanitationSR).insert(serviceRequest);
