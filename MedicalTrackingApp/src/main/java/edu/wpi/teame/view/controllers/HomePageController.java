...
public class HomePageController {
    ...
    private void onLoadCSVButtonClick() throws IOException, CsvValidationException, SQLException {
        ...
        DBManager.getInstance().getMedicalEquipmentSRManager().readCSV("MedicalEquipmentDeliverServiceRequestSave.csv");
        DBManager.getInstance().getMedicineDeliverySRManager().readCSV("MedicineDeliveryServiceRequestSave.csv");
    ...
    public void writeToCSVFiles(MouseEvent mouseEvent) throws SQLException, IOException {
        ...
        MedicineDeliveryServiceRequestManager medReqManager = new MedicineDeliveryServiceRequestManager();
