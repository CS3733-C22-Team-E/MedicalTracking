...
public final class MentalHealthServiceRequest extends ServiceRequest {
  ...
  public MentalHealthServiceRequest(
      ...
      Patient patient) {
    super(
        DataBaseObjectType.MentalHealthSR,
        priority,
        status,
        additionalInfo,
        assignee,
  ...
  public MentalHealthServiceRequest(ResultSet resultSet) throws SQLException {
    super(resultSet, DataBaseObjectType.MentalHealthSR);
    this.patient =
        (Patient)
  ...
  public MentalHealthServiceRequest(CSVLineData lineData) throws SQLException, ParseException {
    super(lineData, DataBaseObjectType.MentalHealthSR);
