    ...
    public Edge decode(BsonReader reader, DecoderContext decoderContext) {
        ...
        while (reader.readBsonType() != BsonType.END_OF_DOCUMENT) {
            ...
            if (fieldName.equals("_id")) {
                ...
                try {
                    edge.setStart((Location) DBManager.getInstance().getManager(DataBaseObjectType.Location).get(reader.readInt32()));
                ...
                try {
                    edge.setEnd((Location) DBManager.getInstance().getManager(DataBaseObjectType.Location).get(reader.readInt32()));
                } catch (SQLException e) {
                    e.printStackTrace();
                    System.exit(2);
                }
