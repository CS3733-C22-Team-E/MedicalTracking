...
public class MedicalEquipmentServiceRequestCodec implements Codec<MedicalEquipmentServiceRequest> {
    ...
    public MedicalEquipmentServiceRequest decode(BsonReader reader, DecoderContext decoderContext) {
        ...
        while (reader.readBsonType() != BsonType.END_OF_DOCUMENT) {
            ...
            if (fieldName.equals("_id")) {
                ...
                try {
                    serviceRequest.setEquipment((Equipment) DBManager.getInstance().getManager(DataBaseObjectType.Equipment).get(reader.readInt32()));
                } catch (SQLException e) {
                    e.printStackTrace();
                    System.exit(2);
                }
    ...
    @Override
    public void encode(BsonWriter writer, MedicalEquipmentServiceRequest value, EncoderContext encoderContext) {
