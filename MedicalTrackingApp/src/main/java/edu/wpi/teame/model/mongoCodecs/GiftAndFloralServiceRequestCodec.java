...
public class GiftAndFloralServiceRequestCodec implements Codec<GiftAndFloralServiceRequest> {
    ...
    @Override
    public void encode(BsonWriter writer, GiftAndFloralServiceRequest value, EncoderContext encoderContext) {
    ...
    @Override
    public Class<GiftAndFloralServiceRequest> getEncoderClass() {
        return GiftAndFloralServiceRequest.class;
    }
}
