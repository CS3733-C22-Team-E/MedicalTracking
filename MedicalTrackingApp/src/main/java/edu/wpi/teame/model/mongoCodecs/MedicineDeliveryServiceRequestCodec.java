...
public class MedicineDeliveryServiceRequestCodec implements Codec<MedicineDeliveryServiceRequest> {
    @Override
    public MedicineDeliveryServiceRequest decode(BsonReader reader, DecoderContext decoderContext) {
        MedicineDeliveryServiceRequest serviceRequest = new MedicineDeliveryServiceRequest();
        ...
        while (reader.readBsonType() != BsonType.END_OF_DOCUMENT) {
            ...
            } else if(fieldName.equals("medicineName")) {
                serviceRequest.setMedicineName(reader.readString());
            ...
            } else if(fieldName.equals("medicineQuantity")) {
                serviceRequest.setMedicineQuantity(reader.readString());
            }
        }
    ...
    @Override
    public void encode(BsonWriter writer, MedicineDeliveryServiceRequest value, EncoderContext encoderContext) {
        ...
        writer.writeString("medicineName", value.getMedicineName());
        writer.writeInt32("patientID", value.getPatient().getId());
        writer.writeString("medicineQuantity", value.getMedicineQuantity());
        writer.writeInt32("isDeleted", value.getIsDeleted() ? 1 : 0);
        writer.writeEndDocument();
    }

    @Override
    public Class<MedicineDeliveryServiceRequest> getEncoderClass() {
        return MedicineDeliveryServiceRequest.class;
    }
}
