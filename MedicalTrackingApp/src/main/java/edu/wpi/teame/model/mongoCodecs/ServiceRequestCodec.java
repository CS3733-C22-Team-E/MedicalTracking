...
public class ServiceRequestCodec implements Codec<ServiceRequest> {
    @Override
    ...
    @Override
    public void encode(BsonWriter writer, ServiceRequest value, EncoderContext encoderContext) {
    ...
    @Override
    public Class<ServiceRequest> getEncoderClass() {
