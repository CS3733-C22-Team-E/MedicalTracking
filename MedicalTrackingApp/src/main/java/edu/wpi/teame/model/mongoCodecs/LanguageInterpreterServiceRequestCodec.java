...
public class LanguageInterpreterServiceRequestCodec implements Codec<LanguageInterpreterServiceRequest> {
    @Override
    public LanguageInterpreterServiceRequest decode(BsonReader reader, DecoderContext decoderContext) {
        ...
        while (reader.readBsonType() != BsonType.END_OF_DOCUMENT) {
            ...
            if (fieldName.equals("_id")) {
                ...
                try {
                    serviceRequest.setLocation((Location) DBManager.getInstance().getManager(DataBaseObjectType.Location).get(reader.readInt32()));
                ...
                try {
                    serviceRequest.setAssignee((Employee) DBManager.getInstance().getManager(DataBaseObjectType.Employee).get(reader.readInt32()));
                } catch (SQLException e) {
                    e.printStackTrace();
                    System.exit(2);
                }
                ...
                serviceRequest.setLanguage(LanguageType.values()[reader.readInt32()]);
    ...
    @Override
    public void encode(BsonWriter writer, LanguageInterpreterServiceRequest value, EncoderContext encoderContext) {
    ...
    @Override
    public Class<LanguageInterpreterServiceRequest> getEncoderClass() {
        return LanguageInterpreterServiceRequest.class;
    }
}
