...
public final class SanitationSRManager extends ObjectManager<ServiceRequest> {
    public SanitationSRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getSanitationSRManager().insert(newSR);
