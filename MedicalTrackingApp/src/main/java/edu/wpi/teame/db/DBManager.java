...
public final class DBManager {
  ...
  public void setupDB() throws SQLException {
    ...
    String createEmployeeTable =
        "CREATE TABLE Employee(id int Primary Key GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), "
            + "department int, "
            + "name VARCHAR(100), "
            + "isDoctor int)";
    ...
    String createEquipmentServiceRequestTable =
        "CREATE TABLE MedicalEquipmentSR(id int Primary Key NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), "
            + "locationID int, "
            + "status int, "
            + "employeeID int, "
            + "closeDate Date, "
    ...
    String createMedicineDeliverySRTable =
        "CREATE TABLE MedicineDeliverySR(id int Primary Key NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), "
            + "locationID int, "
            + "status int, "
            + "employeeID int, "
            + "closeDate Date, "
    ...
    String createSanitationSRTable =
        "CREATE TABLE SanitationSR(id int Primary Key NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), "
            + "locationID int, "
            + "status int, "
            + "employeeID int, "
            + "closeDate Date, "
    ...
    String createSecuritySRTable =
        "CREATE TABLE createSecuritySRTable(id int Primary Key NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), "
            + "locationID int, "
            + "status int, "
            + "employeeID int, "
            + "closeDate Date, "
