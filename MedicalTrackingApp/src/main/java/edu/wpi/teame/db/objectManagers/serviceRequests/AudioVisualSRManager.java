...
public final class AudioVisualSRManager extends ObjectManager<ServiceRequest> {
    public AudioVisualSRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getAudioVisualSRManager().insert(newSR);
        }
    }
