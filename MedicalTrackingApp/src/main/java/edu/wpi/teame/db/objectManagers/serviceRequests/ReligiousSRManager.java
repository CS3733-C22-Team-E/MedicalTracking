...
public final class ReligiousSRManager extends ObjectManager<ReligiousServiceRequest> {
  ...
  public void readCSV(String inputFileName)
    ...
    while ((record = csvReader.readNext()) != null) {
      ...
      String religion = lineData.getColumnString("religion");
      ...
      // select patient where id = patientID
      PatientManager patientManager = new PatientManager();
      Patient newPatient = patientManager.get(patient);

      //new ServiceRequest
      ReligiousServiceRequest newSR = new ReligiousServiceRequest(priority, requestStatus, additionalInfo, newEmployee, newLocation, requestDate, closeDate, openDate, title, id, newPatient, religion);
  ...
  public void writeToCSV(String outputFileName) throws IOException, SQLException {
    ...
    data.add(new String[] {"id", "locationID", "assigneeID", "openDate", "closeDate", "status", "title", "additionalInfo", "priority", "requestDate", "patientID", "religion"});
