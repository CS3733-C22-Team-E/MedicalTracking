...
public final class LaundrySRManager extends ObjectManager<ServiceRequest> {
    public LaundrySRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getLaundrySRManager().insert(newSR);
        }
    }
