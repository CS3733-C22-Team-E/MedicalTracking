...
public class LocationManager implements IManager<Location> {
  ...
  public void writeToCSV(String outputFilePath) {
    ...
    try {
      ...
      StringBuffer title = new StringBuffer("nodeID,xcoord,ycoord,floor,building,nodeType,longName,shortName");
      ...
      for (Location location : locationList) {
        ...
        oneLine.append(
                xcoord == null || (xcoord.trim().length() == 0)
                        ? ""
                        : locationType);
        // Add comma separator
        oneLine.append(csvSeparator);
        ...
        oneLine.append(
                ycoord == null || (ycoord.trim().length() == 0)
                        ? ""
                        : ycoord);
        // Add comma separator
        oneLine.append(csvSeparator);
        // Add floor to buffer
        oneLine.append(
                floorType == null || (floorType.trim().length() == 0)
                        ? ""
                        : floorType);
        // Add comma separator
        oneLine.append(csvSeparator);
        ...
        oneLine.append(
                buildingType == null || (buildingType.trim().length() == 0)
                        ? ""
                        : buildingType);
        // Add comma separator
        oneLine.append(csvSeparator);
        ...
        oneLine.append(
                locationType == null || (locationType.trim().length() == 0)
                        ? ""
                        : locationType);
        // Add comma separator
        oneLine.append(csvSeparator);
