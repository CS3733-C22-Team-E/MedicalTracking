...
public final class ComputerSRManager extends ObjectManager<ServiceRequest> {
    public ComputerSRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getComputerSRManager().insert(newSR);
        }
    }
