...
public final class SecuritySRManager extends ObjectManager<ServiceRequest> {
    public SecuritySRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getSecuritySRManager().insert(newSR);
