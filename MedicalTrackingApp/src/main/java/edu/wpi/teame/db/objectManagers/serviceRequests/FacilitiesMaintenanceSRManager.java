...
public final class FacilitiesMaintenanceSRManager extends ObjectManager<ServiceRequest> {
    public FacilitiesMaintenanceSRManager(DataBaseObjectType dbType) throws SQLException {
        super(dbType);
    }
    ...
    public void readCSV(String inputFileName)
        ...
        while ((record = csvReader.readNext()) != null) {
            ...
            DBManager.getInstance().getFacilitiesMaintenanceSRManager().insert(newSR);
        }
    }
