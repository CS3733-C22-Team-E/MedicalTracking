...
public class Main {
  ...
  public static void main(String[] args)
    ...
    //    Employee emp1 = new Employee(1, DepartmentType.FAMILYMEDICINE, "Shannon L",
    // EmployeeType.Admin);
    //    Employee emp2 =
    //        new Employee(2, DepartmentType.CLINICALSERVICES, "Madelyn Pearson",
    // EmployeeType.Staff);
    //    Employee emp3 =
    //        new Employee(
    //            3, DepartmentType.PLASTICSURGERY, "John Ronald Reagan Tolkien",
    // EmployeeType.Admin);
    //
    ...
    //    System.out.println();
    //    /**
    //     * DataBaseObjectType type, ServiceRequestPriority priority, ServiceRequestStatus status,
    // String
    //     * additionalInfo, Employee assignee, Location location, Date requestDate, Date closeDate,
    // Date
    ...
    //
    //    //     secReqManager.update(
    //    //             new ServiceRequest(DataBaseObjectType.SecuritySR,
    // ServiceRequestPriority.High,
    //    // ServiceRequestStatus.OPEN, "I need swecurity", emp1, loc1,  Date.valueOf("2015-03-31"),
    // null,
    //    // date, "titel",0));
    ...
    //
    //    //     sanReqManager.update(
    //    //         new SanitationServiceRequest(ServiceRequestStatus.CLOSED, emp1, loc1, date,
    // date,
    //    // 1));
    //    //
    //    //     System.out.println();
    ...
    //
    //    /**
    //     * ServiceRequestPriority priority, ServiceRequestStatus status, String additionalInfo,
    // Employee
    //     * assignee, Location location, Date requestDate, Date closeDate, Date openDate, String
    // title,
