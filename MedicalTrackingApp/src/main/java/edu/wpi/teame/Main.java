...
import edu.wpi.teame.model.serviceRequests.StandardServiceRequest;
...
public class Main {
  ...
  public static void main(String[] args) throws IOException, SQLException {
     ...
     ServiceRequest secReq1 =
         new ServiceRequest(ServiceRequestPriority.High, ServiceRequestStatus.OPEN, DataBaseObjectType.SecuritySR, "I need swecurity", emp1, loc1, date, );
    StandardServiceRequest secReq2 =
         new StandardServiceRequest(ServiceRequestStatus.PENDING, emp2, loc2, date, date, 2);
    StandardServiceRequest secReq3 =
         new StandardServiceRequest(ServiceRequestStatus.CLOSED, emp3, loc3, date, date, 3);
